...
Display label: **HB-Rachel** (formerly ``hb_integration.py`` /
``HBRachelObserver``; the old module path and class name remain importable
via the compatibility alias at the bottom of this file).
...
# The class was renamed HBIntegrationObserver -> HBRachelObserver (and the
# module hb_integration.py -> hb_rachel.py) so the code matches the team's
# "HB-Rachel" naming. Old imports keep working:
#     from observers.models.hb_rachel import HBIntegrationObserver   # alias
# and a shim module observers/models/hb_integration.py re-exports everything.
# ---------------------------------------------------------------------------
HBIntegrationObserver = HBRachelObserver
